    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 dark:bg-gray-800 shadow sm:rounded-lg" style="background-color:rgb(101, 80, 42);">
                <div class="max-w-xl">
                    <section>
                        <form method="POST" action="{{ route('products.storeProduct') }}" class="mt-6 space-y-6">
                            @csrf
                            <div>
                            ...
                            <div>
                                ...
                                <x-text-input id="price" name="price" type="text"
                                    class="mt-1 block w-full" :value="old('price')" required autofocus autocomplete="price" />
                            ...
                            <div>
                                ...
                                <x-text-input id="discount" name="discount" type="text"
                                    class="mt-1 block w-full" :value="old('discount')" required autofocus autocomplete="name" />
                            ...
                            <div>
                                ...
                                <textarea id="details" name="details" rows="4"
                                    ...
                                    style="background-color:rgba(76, 52, 6, 1);" required>{{ old('details') }}</textarea>
                                <x-input-error class="mt-2" :messages="$errors->get('details')" />
                            </div>
                            <div>
                                <x-input-label for="quantity" :value="__('Quantity')" />
                                <x-text-input id="quantity" name="quantity" type="text"
                                    class="mt-1 block w-full" :value="old('quantity')" required autofocus autocomplete="quantity" />
