                    ...
                    <div class="bg-p-medium rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <a href="/product/{{ $product->id }}" class="bg-p-light hover:bg-p-light/80 text-p-dark font-bold py-2 px-4 rounded-full text-sm transition duration-300">View Details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
