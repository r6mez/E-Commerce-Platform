    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-p-dark shadow sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('seller.products.update', $product) }}" class="mt-6 space-y-6"
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text"
                            class="mt-1 block w-full bg-p-medium text-p-light" :value="old('name', $product->name)"
                    ...
                    <div>
                        ...
                        <x-text-input id="price" name="price" type="text"
                            class="mt-1 block w-full bg-p-medium text-p-light" :value="old('price', $product->price)"
                            required />
